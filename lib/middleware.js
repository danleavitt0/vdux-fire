  ...
  function addListener(_ref3) {
    ...
    if (type === 'once') {
      return dbref.once('value').then(function (snap) {
        ...
        return join ? joinResults(value) : value;
      }).then(function (value) {
    ...
    dbref.on('value', function (snap) {
      ...
      var p = join ? joinResults(value) : Promise.resolve(value);
    ...
    function joinResults(value) {
      return buildChildRef(value, db.ref(join.ref), join).then(function (snap) {
